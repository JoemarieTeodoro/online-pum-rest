...
public class EmployeeValidator implements Validator<Employee> {
    ...
    protected boolean isValidEmailAddress( Employee employee ) throws InvalidCSVException {
        return ValidationUtils.regexValidator( employee, employee.getIntranetId() , ValidationUtils.VALID_EMAIL_REGEX, OpumConstants.INVALID_EMAIL_ADDRESS );
    }
    ...
    protected boolean isValidEmployeeSerial( Employee employee ) throws InvalidCSVException {
        return ValidationUtils.regexValidator( employee, employee.getEmployeeSerial(), ValidationUtils.VALID_SERIAL_REGEX, OpumConstants.INVALID_EMPLOYEE_ID );
    }
    ...
    protected boolean isValidEmployeeName( Employee employee ) throws InvalidCSVException {
        return ValidationUtils.regexValidator( employee, employee.getFullName(), ValidationUtils.VALID_NAME_REGEX, OpumConstants.INVALID_NAME );
    }
}
